...
\begin{itemize}[noitemsep,topsep=1pt]
\item \ttt{characterData: \textcolor{green}{CharacterData}}
\item \ttt{gameData: \textcolor{green}{GameData}}
\item \ttt{guildData: \textcolor{green}{GuildData}}
\item \ttt{progressRaceData: \textcolor{green}{ProgressRaceData}}
\item \ttt{rateLimitData: \textcolor{green}{RateLimitData}}
\item \ttt{reportData: \textcolor{green}{ReportData}}
\item \ttt{userData: \textcolor{green}{UserData}}
\item \ttt{worldData: \textcolor{green}{WorldData}}
\end{itemize}
\end{itemize}
...
\item \ttt{reportData}
\begin{itemize}[noitemsep,topsep=1pt]
\item \ttt{report(code: \textcolor{green}{String}): \textcolor{green}{Report}}
\item \ttt{reports(endTime: \textcolor{green}{Float}, \\guildID: \textcolor{green}{Int}, \\guildName: \textcolor{green}{String}, \\guildServerSlug: \textcolor{green}{String}, \\guildServerRegion: \textcolor{green}{String}, \\guildTagID: \textcolor{green}{Int}, \\userID: \textcolor{green}{Int}, \\limit: \textcolor{green}{Int}, \\page: \textcolor{green}{Int}, \\startTime: \textcolor{green}{Float}, \\zoneID: \textcolor{green}{Int}, \\gameZoneID: \textcolor{green}{Int}}): \textcolor{green}{ReportPagination}
\end{itemize}
\end{itemize}
...
\item \ttt{code: \textcolor{green}{String!}}
\item \ttt{endTime: \textcolor{green}{Float!}}
\item \ttt{events(abilityID: \textcolor{green}{Float}, \\dataType: \hyperref[sec:EventDataType]{\textcolor{green}{EventDataType}}, \\death: \textcolor{green}{Int}, \\difficulty: \textcolor{green}{Int}, \\encounterID: \textcolor{green}{Int}, \\endTime: \textcolor{green}{Float}, \\fightsIDs: [\textcolor{green}{Int}], \\ filterExpression: \textcolor{green}{String}, \\hostilityType: \hyperref[sec:HostilityType]{\textcolor{green}{HostilityType}}, \\includeResources: \textcolor{green}{Boolean}, \\killType: \hyperref[sec:KillType]{\textcolor{green}{KillType}}, \\limit: \textcolor{green}{Int}, \\sourceAurasAbsent: \textcolor{green}{String}, \\sourceAurasPresent: \textcolor{green}{String}, \\sourceClass: \textcolor{green}{Int}, \\sourceID: \textcolor{green}{Int},  \\sourceInstanceID: \textcolor{green}{Int}, \\startTime: \textcolor{green}{Float}, \\targetAurasAbsent: \textcolor{green}{String}, \\targetAurasPresent: \textcolor{green}{String}, \\targetClass: \textcolor{green}{String}, \\targetID: \textcolor{green}{Int}, \\targetInstanceID: \textcolor{green}{Int}, \\translate: \textcolor{green}{Boolean}, \\useAbilityIDs: \textcolor{green}{Boolean}, \\useActorIDs: \textcolor{green}{Boolean}, \\viewOptions: \textcolor{green}{Int}, \\wipeCutoff: \textcolor{green}{Int}): \textcolor{green}{ReportEventPaginator}}
...
\subsubsection{ReportEventPaginator}

\begin{itemize}[noitemsep,topsep=1pt]
\item \ttt{event}
\begin{itemize}[itemsep=1pt,topsep=1pt]
\item \ttt{data: \textcolor{green}{JSON}}
\item \ttt{nextPageTimestamp: \textcolor{green}{Float}}
\end{itemize}
\end{itemize}
...
\subsection{\ttt{ReportPagination}}

\begin{itemize}[noitemsep,topsep=1pt]
\item \ttt{reportPagination}
\begin{itemize}[itemsep=1pt,topsep=1pt]
\item \ttt{data: [\textcolor{green}{Report}]}
\item \ttt{total: \textcolor{green}{Int}!}
\item \ttt{per\_page: \textcolor{green}{Int}!}
\item \ttt{current\_page: \textcolor{green}{Int}!}
\item \ttt{from: \textcolor{green}{Int}}
\item \ttt{to: \textcolor{green}{Int}}
\item \ttt{last\_page: \textcolor{green}{Int}!}
\item \ttt{has\_more\_pages: \textcolor{green}{Boolean}!}
\end{itemize}
\end{itemize}
